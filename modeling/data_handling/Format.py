    ...
    def save(self, data, save_path, img_path, img_type, manifest_path):
        ...
        try:
            ...
            with open(os.path.abspath(manifest_abspath), "w") as manifest_file:
                ...
                for key in data:
                    # print("".join([key, img_type, "\n"]))
                    # print(key, img_type)
                    # os.makedirs(os.path.abspath(img_path), exist_ok=True)
                    # print(save_path)
                    # print(key.split('/')[0])
                    os.makedirs(os.path.abspath(os.path.join(save_path, key.split('/')[0])), exist_ok=True)
