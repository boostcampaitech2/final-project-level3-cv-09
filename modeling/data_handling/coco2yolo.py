...
parser.add_argument('--datasets', default = "COCO", type=str, help='type of datasets')
parser.add_argument('--img_path', default = r"Z:\dvc_version\inputs\train",  type=str, help='directory of image folder')
parser.add_argument('--label', default = r"Z:\dvc_version\inputs\train\train.json", type=str,
                    help='directory of label folder or label file path')
parser.add_argument('--convert_output_path', default =  r"Z:\dvc_version\inputs\train", type=str,
                    help='directory of label folder')
parser.add_argument('--img_type', default = r".jpg", type=str, help='type of image')
...
parser.add_argument('--cls_list_file', type=str,
                    help='directory of *.names file', default= r".\food.names")
